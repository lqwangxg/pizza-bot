...
module.exports = class MessengerLine {
    ...
    validate_signature(req){
        ...
        for (let o of this._option_list){
            ...
            debug(`Going to validate using channel_id "${o.channel_id}", switcher_secret:${o.switcher_secret}`);
            debug(`channel_secret: "${o.channel_secret}", raw_body:${raw_body}, `)
            debug(`hash: "${hash}", raw_body:${signature}, `)
