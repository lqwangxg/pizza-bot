...
module.exports = class Flow {
    ...
    async respond(){
        ...
        let response = await this.context.skill.finish(this.bot, this.event, this.context);
        this.context.responseBody = response;
        debug(`response after bot.reply: ${response}`);
