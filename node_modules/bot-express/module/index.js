...
module.exports = (options) => {
    ...
    router.post('/', async (req, res, next) => {
        ...
        } else if (req.get("CLIENT-TYPE")){
            const clientType = req.get("CLIENT-TYPE");
            debug(`now webclient only.CLIENT-TYPE:${clientType}`);
        ...
        */
        ...
        debug(`context.responseBody : ${context.responseBody}`);
        if(messenger_type === "webclient"){
          debug(`@@@context@@@:${context}`);
          return res.json(context.responseBody);
        }
    });
