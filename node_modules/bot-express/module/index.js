...
@param {Object} [options.messenger.webclient] - Messenger configuration for Google Assistant.
@param {String} [options.messenger.webclient.org_id] - Project ID of Google Platform. Required when you use Google Assistant as messenger.
...
module.exports = (options) => {
    ...
    router.post('/', async (req, res, next) => {
        ...
        if (req.get("X-Line-Signature") && req.body.events){
            ...
            debug(`CLIENT-TYPE:${clientType}`);
            if(clientType === "google-client"){
              messenger_type = "google";
            }else{
              messenger_type = "webclient";
            }
        ...
        try {
            ...
            debug(`context.replyMessage:${context.replyMessage}`);
            if(clientType && context.replyMessage){
              await this.res.status(200).json(context.replyMessage);
            }
        } catch(e){
